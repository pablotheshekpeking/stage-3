...
const Card = ({ photo, index, moveCard }) => {
  const imageUrl = "https://api.unsplash.com/search/photos&Client-ID='6rgrQws5g38YYhiB5AXFhhSXKCaUM-N_sl-T7Mpt2_4'"; // Use the appropriate Unsplash API property for the image URL
